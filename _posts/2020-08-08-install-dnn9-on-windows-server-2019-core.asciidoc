...
Remove-WebBinding -Name dnn9.hostname.local -HostHeader dnn9.hostname.local 
New-WebBinding -Name dnn9.hostname.local -port 443 -Protocol https -HostHeader dnn9.hostname.local
----
